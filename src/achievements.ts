...
export const achievements: ReadonlyArray<Achievement> = (
  [
    ...
    [477, "CRÊPE ESCAPE", "RouteComplete"],
    [478, "LA BOUCLE", "RouteComplete"],
    [479, "PARIS TOUJOURS", "RouteComplete"],
    [480, "HEART OF MONTMARTRE", "RouteComplete"],
    [481, "DOUBLE ESPRESSO", "RouteComplete"],
    [482, "MONTMARTRE MIXER", "RouteComplete"],
    [483, "LOOP DE LOOP DE LOOP", "RouteComplete"],
    [484, "CIRQUE DU SUFFER", "RouteComplete"],
    [485, "RUES IN RYTHME", "RouteComplete"],
    [486, "PARIS PACER", "RouteComplete"],
    [487, "TWILIGHT CRIT", "RouteComplete"],
    [488, "MECH ISLE MAYHEM", "RouteComplete"],
    [489, "WHAT YUMEZI WERE LOST", "RouteComplete"],
    [490, "URUMAZE", "RouteComplete"],
  ] as const
